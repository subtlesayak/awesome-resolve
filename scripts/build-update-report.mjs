...
export function buildUpdateReport(){
 ...
 'This historical audit covers the 72 external entries available at its snapshot. See [community discovery evidence](community-discoveries.json) for the 32 subsequently added resources.','',

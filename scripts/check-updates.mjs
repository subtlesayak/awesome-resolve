...
async function fetchPage(url){
 ...
 try{
  const response=await fetch(url,{signal:AbortSignal.timeout(25000),headers:{'User-Agent':'Awesome-Resolve-List-Link-Check/1.0','Accept':'text/html,application/json;q=0.9,*/*;q=0.5'}});

...
|---|---|---|---|
| [Blackmagic Cloud Manual](https://help.cloud.blackmagicdesign.com/intro/what-is-blackmagic-cloud/) | 🆓 Public reference; original terms apply | 📖 Reference | Online help for Blackmagic Cloud accounts, project libraries, collaboration and cloud workflows. Services can require an account and paid storage. Support listing dated 2026-09-08. |
| [Blackmagic Design email support](https://www.blackmagicdesign.com/support/contact/email) | 🆓 Public reference; original terms apply | 📖 Reference | Official support enquiry form. Choose a product and region; support eligibility varies, and free Resolve technical support is provided through the community forum. |
| [Blackmagic Design regional support contacts](https://www.blackmagicdesign.com/support/contact/phone) | 🆓 Public reference; original terms apply | 📖 Reference | Official regional telephone support directory. Check local office hours and product support eligibility. |
...
| [Blackmagic RAW SDK Manual](https://documents.blackmagicdesign.com/DeveloperManuals/BlackmagicRAW-SDK.pdf) | 🆓 Public reference; original terms apply | 📖 Reference | Developer reference for applications integrating Blackmagic RAW decoding and processing. This is separate from the Resolve scripting API. Support listing dated 2025-08-07. |
| [DaVinci Advanced Panel Keycaps Installation Guide](https://documents.blackmagicdesign.com/InstallationGuides/DaVinciAdvancedPanelKeycapsInstall.pdf) | 🆓 Public reference; original terms apply | 📖 Reference | Instructions for replacing keycaps on the Resolve Advanced Panel. Support listing dated 2021-03-09. |
...
| [DaVinci Resolve 20 Supported Codecs](https://documents.blackmagicdesign.com/SupportNotes/DaVinci_Resolve_20_Supported_Codec_List.pdf) | 🆓 Public reference; original terms apply | 📖 Reference | Format and codec support tables for Resolve 20. Consult OS and Free/Studio distinctions; this document does not establish Resolve 21.1 support. Support listing dated 2025-07-07. |
| [DaVinci Resolve 21 New Features Guide](https://documents.blackmagicdesign.com/SupportNotes/DaVinci_Resolve_21_New_Features_Guide.pdf) | 🆓 Public reference; original terms apply | 📖 Reference | Guide to features introduced in Resolve 21; this is the 21 guide, not a complete 21.1 changelog. Support listing dated 2026-04-16. |
| [DaVinci Resolve 21.1 Manual](https://documents.blackmagicdesign.com/UserManuals/DaVinci_Resolve_21.1_Reference_Manual.pdf) | 🆓 Public reference; original terms apply | 📖 Reference | Editing, color grading, Fairlight audio, Fusion and delivery reference for Resolve 21.1. Support listing dated 2026-09-08. |
...
| [DaVinci Resolve Wide Gamut Intermediate](https://documents.blackmagicdesign.com/InformationNotes/DaVinci_Resolve_17_Wide_Gamut_Intermediate.pdf) | 🆓 Public reference; original terms apply | 📖 Reference | Technical reference for DaVinci Wide Gamut and Intermediate color space. Published for Resolve 17; it is not an application release. Support listing dated 2021-08-12. |
| [Desktop Video Manual](https://documents.blackmagicdesign.com/UserManuals/DesktopVideoManual.pdf) | 🆓 Public reference; original terms apply | 📖 Reference | Installation and operation reference for DeckLink and UltraStudio capture/playback hardware used with Resolve monitoring workflows. Support listing dated 2026-04-08. |
| [Fairlight Console Assembly Instruction Manual](https://documents.blackmagicdesign.com/UserManuals/Fairlight_Console_Assembly_Manual.pdf) | 🆓 Public reference; original terms apply | 📖 Reference | Assembly and module installation instructions for Fairlight consoles used with Resolve. Support listing dated 2020-02-05. |
| [Fairlight Desktop Console Operation Manual](https://documents.blackmagicdesign.com/UserManuals/Fairlight_Desktop_Console_Operation_Manual.pdf) | 🆓 Public reference; original terms apply | 📖 Reference | Operation reference for the Fairlight Desktop Console and its audio-post controls. Hardware is required to follow console workflows. Support listing dated 2024-11-26. |
...
| [Fusion 18 GPU Accelerated Tool Comparison Guide](https://documents.blackmagicdesign.com/UserManuals/Fusion_GPU_Accelerated_Tools.pdf) | 🆓 Public reference; original terms apply | 📖 Reference | Version-specific comparison of GPU-accelerated tools in Resolve, Resolve Studio and Fusion Studio. This 2022 guide is not a current compatibility matrix. Support listing dated 2022-07-25. |
| [Fusion 21.1 User Manual](https://documents.blackmagicdesign.com/UserManuals/FusionManual.pdf) | 🆓 Public reference; original terms apply | 📖 Reference | Node-based compositing and effects reference for Fusion 21.1. Support listing dated 2026-09-08. |
| [Fusion 8 Scripting Guide](https://documents.blackmagicdesign.com/UserManuals/Fusion8_Scripting_Guide.pdf) | 🆓 Public reference; original terms apply | 📖 Reference | Legacy FusionScript API introduction for automating and extending Fusion 8. Check current API documentation before reusing examples. Support listing dated 2016-04-01. |
...
| [What’s New in DaVinci Resolve 21.1](https://player.vimeo.com/video/1224498809?dnt=1) | 🆓 Public video; original terms apply | 📖 Reference | Official overview video of Resolve 21.1 features, including AI assistant integration, expanded still photography tools and editing/color controls. Listed by Blackmagic support on September 8, 2026. |
...
| [Reactor](https://gitlab.com/WeSuckLess/Reactor) | 📦 Public package manager; package terms vary | ❔ Per package | Canonical GitLab home of the Fusion/Resolve Atom package ecosystem. Browse the [Atom tree](https://gitlab.com/WeSuckLess/Reactor/-/tree/master/Atoms) and [community forum](https://www.steakunderwater.com/wesuckless/). The browser tree returned a loading shell; a later API scan retrieved all 707 manifests. See the [package inventory](https://github.com/subtlesayak/subtle-resolve-list/blob/main/data/reactor-inventory.md); compatibility still varies by package. Related standalone tooling is already in the GitHub catalogue. |
